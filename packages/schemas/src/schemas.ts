...
export const API_ENDPOINTS = {
  ...
  EMPLOYEES_ID: (id: string) => `/api/v1/employees/${id}`,

  // Vehicles
  VEHICLES: '/api/v1/vehicles',
  VEHICLES_ID: (id: string) => `/api/v1/vehicles/${id}`,

  // Trips
  TRIPS: '/api/v1/trips',
  TRIPS_ID: (id: string) => `/api/v1/trips/${id}`,

  // Companies
  COMPANIES: '/api/v1/companies',
  COMPANIES_ID: (id: string) => `/api/v1/companies/${id}`,

  // Attendance
  ATTENDANCE: '/api/v1/attendance',
  ATTENDANCE_ID: (id: string) => `/api/v1/attendance/${id}`,

  // Payroll
  PAYROLL: '/api/v1/payroll',
  PAYROLL_ID: (id: string) => `/api/v1/payroll/${id}`,

  // Advances
  ADVANCES: '/api/v1/advances',
  ADVANCES_ID: (id: string) => `/api/v1/advances/${id}`,
};
